...
/* Lavoisier wapet option */
#define XENMEM_memory_phys_map      31
#define XENMEM_debug_startup        32
...
/*By lavoisier wapet , to handle the log in xen*/
struct xen_debug_startup {
   unsigned int nr_chars;
   /* buffer containing the printk log */
   GUEST_HANDLE(void) buffer;
};
DEFINE_GUEST_HANDLE_STRUCT(xen_debug_startup);
...
/*By lavoisier wapet (sepia team)*/
#define XENMEM_get_phys_numainfo            30
/*end by lavoisier wapet*/
